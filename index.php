				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Our New Launched Products</h3>
							<div class="row">
								<?php 
														...
														<div class=\"snipcart-details top_brand_home_details item_add single-item hvr-outline-out\">
															<form action=\"user_controller.php\" method=\"post\">
																<fieldset>
																	...
																	<input type=\"hidden\" name=\"pid\" value=\"$e\" />
																	<input type=\"hidden\" name=\"prnm\" value=\"$a\" />
																	<input type=\"hidden\" name=\"psell\" value=\"$c\" />
																	<input type=\"hidden\" name=\"pimg\" value=\"$d\" />
																	<input type=\"submit\" name=\"add_cart\" value=\"Add to cart\" class=\"button btn\" />
																</fieldset>
															</form>
														</div>
													</div>
